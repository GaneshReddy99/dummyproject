...
public class AppController {
    ...
    private ProductService service;
	        ...
	        @RequestMapping("/edit/{car_id}")
	        public ModelAndView showEditProductPage(@PathVariable(name = "car_id") long car_id) {
	            ModelAndView mav = new ModelAndView("edit_product");
	            Product product = service.get(car_id);
	            mav.addObject("product", product);
	             
	            return mav;
	        }
	        
	        @RequestMapping("/delete/{car_id}")
	        public String deleteProduct(@PathVariable(name = "car_id") int car_id) {
